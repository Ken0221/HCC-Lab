...
# message1 = ["command", "takeoff", "forward 170", "up 80", "forward 180", "land"]
message1 = ["command", "takeoff", "flip f", "land"]
# delay = [2, 4, 5, 4, 5, 1]
delay = [2, 4, 5, 1]

# Flag to indicate when to stop the recv thread
...
# Signal the recv thread to stop and wait for it to finish
stop_event.set()
recvThread.join()