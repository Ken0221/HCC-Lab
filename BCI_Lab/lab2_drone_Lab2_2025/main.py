...
class ParameterStorage(object):#方便存放回傳參數用
  def __init__(self):
    ...
    # training phase
    self.EPOCH = 10             # trials per training stage (L/R stage trials are EPOCH*3 labels)
    ...
    self.lr_data = None               # Left & Right 階段 (trial,ch, 2秒) [2秒 cue後訊號]
    self.label_list = []              # Left & Right 階段 (trial, )
